...
public class ThreadImparOuPar extends Thread {
        ...
        try {
            ...
            switch (escolha) {
                case 'P':
                    ...
                    response.setResultado(resp <= 0 ? "Par" : "Ímpar");
                ...
                case 'I':
                    ...
                    response = new MsgResponse(null, resp);
                    response.setResultado(resp >= 0 ? "Ímpar" : "Par");
                    out.writeObject(response);
                    break;
    ...
    private double jogarPar(Random nuRandom, double valor1) {
        double valorComputador = nuRandom.nextDouble() * 5;  // Gera um número aleatório para o computador
